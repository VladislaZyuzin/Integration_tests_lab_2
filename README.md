...
В ходе лабораторной работы я ознакомился с работой интеграционных тестов, которые проверяют связь и работоспособность таких составляющих сервиса, как API, БД и само приложение
